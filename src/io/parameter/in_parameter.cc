...
# 2DPERT: 0,1 controls use of 2d-perturbations
#         0: no 2d-perturbation 
#         1: 2d-perturbation is on 
#
#     NTG   NRDGL    RLAM   DLAMT
        0       0     0.0     0.0
#  ALPHLJ   ALPHC    NLAM  NSCALE  PERT2D
      0.0     0.0       1       0       0
END
@endverbatim
 */
void io::In_Parameter::read_PERTURBATION(simulation::Parameter &param,
  ...
  switch (param.perturbation.pert2d) {
    case 0:
      break;
    case 1:
      param.force.interaction_function = simulation::lj_crf_2d_func;
      break;
    case 2:
      param.force.interaction_function = simulation::lj_crf_pert_eds_func;
      break;
    default:
      io::messages.add("PERTURBATION block: PERT2D must be 0, 1 or 2.",
              "In_Parameter", io::message::error);
  }
...
PRECALCLAM
# NRLAM   0  : off
#         >1 : precalculating energies for NRLAM extra lambda values, used for extended TI
