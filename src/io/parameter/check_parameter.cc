...
#define add(x, y, z) features.push_back(util::Feature((x), (y), (z)))
  ...
  add("pert2d", "2-dimensional perturbations", param.perturbation.pert2d == 1);
...
//  fc.unlock("precalculate_lambdas", "force_groups");
  ...
  fc.unlock("pert2d", "solute");
  fc.unlock("pert2d", "solvent");
  fc.unlock("pert2d", "solvent_only");
  fc.unlock("pert2d", "steepest_descent");
  fc.unlock("pert2d", "solute_constraint_off");
  fc.unlock("pert2d", "solute_shake");
  fc.unlock("pert2d", "solute_lincs");
  fc.unlock("pert2d", "solute_flexshake");
  fc.unlock("pert2d", "solvent_constraint_off");
  fc.unlock("pert2d", "solvent_shake");
  fc.unlock("pert2d", "solvent_lincs");
  fc.unlock("pert2d", "solvent_settle");
  fc.unlock("pert2d", "pressure_calculation");
  fc.unlock("pert2d", "pressure_scale_berendsen");
  fc.unlock("pert2d", "virial_off");
  fc.unlock("pert2d", "virial_atomic");
  fc.unlock("pert2d", "virial_molecular");
  fc.unlock("pert2d", "vacuum");
  fc.unlock("pert2d", "pbc_r");
  fc.unlock("pert2d", "pbc_c");
  fc.unlock("pert2d", "pbc_t");
  fc.unlock("pert2d", "perturbation");
//fc.unlock("pert2d", "perturbation_scaling");
//fc.unlock("pert2d", "slow_growth");
  fc.unlock("pert2d", "individual_lambdas");
//fc.unlock("pert2d", "precalculate_lambdas");
  fc.unlock("pert2d", "bond");
  fc.unlock("pert2d", "angle");
  fc.unlock("pert2d", "dihedral");
  fc.unlock("pert2d", "improper");
  fc.unlock("pert2d", "crf");
  fc.unlock("pert2d", "lj");
  fc.unlock("pert2d", "com_removal");
  fc.unlock("pert2d", "rf_excluded");
  fc.unlock("pert2d", "pairlist_standard");
  fc.unlock("pert2d", "pairlist_grid");
  fc.unlock("pert2d", "pairlist_gridcell");
  fc.unlock("pert2d", "cutoff_atomic");
  fc.unlock("pert2d", "cutoff_cg");
//fc.unlock("pert2d", "cg_martini");
//fc.unlock("pert2d", "cg_gromos");
//fc.unlock("pert2d", "mixed_grain");
  fc.unlock("pert2d", "temp_berendsen");
  fc.unlock("pert2d", "temp_nosehoover");
  fc.unlock("pert2d", "temp_nosehoover_chains");
  fc.unlock("pert2d", "position_rest");
  fc.unlock("pert2d", "position_const");
  fc.unlock("pert2d", "position_const_scaled");
  fc.unlock("pert2d", "distance_rest");
  fc.unlock("pert2d", "distance_field");
  fc.unlock("pert2d", "dihedral_rest");
  fc.unlock("pert2d", "dihedral_const");
  fc.unlock("pert2d", "jvalue_rest");
  fc.unlock("pert2d", "rdc_rest");
  fc.unlock("pert2d", "perscale");
  fc.unlock("pert2d", "rottrans");
  fc.unlock("pert2d", "innerloop_method_off");
  fc.unlock("pert2d", "innerloop_method_generic");
  fc.unlock("pert2d", "innerloop_method_hardcode");
  fc.unlock("pert2d", "innerloop_method_table");
//fc.unlock("pert2d", "innerloop_method_cuda");
  fc.unlock("pert2d", "innerloop_solvent_topology");
  fc.unlock("pert2d", "innerloop_solvent_spc");
//fc.unlock("pert2d", "repex_temp");
//fc.unlock("pert2d", "repex_lambda");
//fc.unlock("pert2d", "multicell");
  fc.unlock("pert2d", "analysis");
  fc.unlock("pert2d", "no_integration");
  fc.unlock("pert2d", "stochdyn");
  fc.unlock("pert2d", "multistep");
  fc.unlock("pert2d", "multistep_boost");
//fc.unlock("pert2d", "montecarlo");
//fc.unlock("pert2d", "polarisation_cos");
//fc.unlock("pert2d", "polarisation_cos_damped");
  fc.unlock("pert2d", "sasa");
  fc.unlock("pert2d", "sasavol");
  fc.unlock("pert2d", "random_gromos");
  fc.unlock("pert2d", "random_gsl");
  fc.unlock("pert2d", "eds");
  fc.unlock("pert2d", "parallel_mpi");
  fc.unlock("pert2d", "parallel_omp");
  fc.unlock("pert2d", "mult_energy_groups");
//fc.unlock("pert2d", "ewald");
//fc.unlock("pert2d", "p3m");
//fc.unlock("pert2d", "leus");
//fc.unlock("pert2d", "bsleus");
//fc.unlock("pert2d", "xray");
//fc.unlock("pert2d", "force_groups");
