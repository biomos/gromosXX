...
#define add(x, y, z) features.push_back(util::Feature((x), (y), (z)))
  ...
  add("pairlist_cuda", "cuda pairlist", param.pairlist.grid == 3);
  ...
  add("cg_gromos", "coarse-grained simulation", param.cgrain.level == 3);
  add("mixed_grain", "mixed-grained simulation", param.cgrain.level == 4);
...
// features that you didn't test or you don't know whether day really work.
  ...
  fc.unlock("solute", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solvent", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solvent_only", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("steepest_descent", "pairlist_cuda"); // mel && axel
...
//  fc.unlock("steepest_descent", "mixed_grain");
  ...
  fc.unlock("solute_constraint_off", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solute_shake", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solute_lincs", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solute_flexshake", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solvent_constraint_off", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solvent_shake", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("pressure_calculation", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("pressure_scale_berendsen", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("virial_off", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("virial_atomic", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("virial_molecular", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("pbc_r", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("pbc_c", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("pbc_t", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("perturbation", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("perturbation_scaling", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("individual_lambdas", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("bond", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("angle", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("dihedral", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("improper", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("crf", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("lj", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("com_removal", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("rf_excluded", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("pairlist_cuda", "cutoff_atomic");
  fc.unlock("pairlist_cuda", "cg_martini");
  fc.unlock("pairlist_cuda", "multi_grain");
  fc.unlock("pairlist_cuda", "cg_gromos");
  fc.unlock("pairlist_cuda", "mixed_grain");
  fc.unlock("pairlist_cuda", "temp_berendsen");
  fc.unlock("pairlist_cuda", "temp_nosehoover");
  fc.unlock("pairlist_cuda", "temp_nosehoover_chains");
  fc.unlock("pairlist_cuda", "position_rest");
  fc.unlock("pairlist_cuda", "position_const");
  fc.unlock("pairlist_cuda", "position_const_scaled");
  fc.unlock("pairlist_cuda", "distance_rest");
  fc.unlock("pairlist_cuda", "dihedral_rest");
  fc.unlock("pairlist_cuda", "dihedral_const");
  fc.unlock("pairlist_cuda", "jvalue_rest");
  fc.unlock("pairlist_cuda", "perscale");
  fc.unlock("pairlist_cuda", "rottrans");
  fc.unlock("pairlist_cuda", "repex_temp");
  fc.unlock("pairlist_cuda", "repex_lambda");
  fc.unlock("pairlist_cuda", "multicell");
  fc.unlock("pairlist_cuda", "analysis");
  fc.unlock("pairlist_cuda", "no_integration");
  fc.unlock("pairlist_cuda", "stochdyn");
  fc.unlock("pairlist_cuda", "multistep");
  fc.unlock("pairlist_cuda", "multistep_boost");
  fc.unlock("pairlist_cuda", "montecarlo");
  fc.unlock("pairlist_cuda", "ramd");
  fc.unlock("pairlist_cuda", "polarisation_cos");
  fc.unlock("pairlist_cuda", "polarisation_cos_damped");
  fc.unlock("pairlist_cuda", "random_gromos");
  fc.unlock("pairlist_cuda", "random_gsl");
  fc.unlock("pairlist_cuda", "parallel_mpi");
  fc.unlock("pairlist_cuda", "parallel_omp");
  ...
  fc.unlock("slow_growth", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("eds", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("mult_energy_groups", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("ewald", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("p3m", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_method_off", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_method_generic", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_method_generic", "ramd");
  ...
  fc.unlock("innerloop_method_hardcode", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_method_hardcode", "ramd");
  ...
  fc.unlock("innerloop_method_table", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_method_table", "ramd");
  ...
  fc.unlock("innerloop_solvent_topology", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_solvent_spc", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solvent_lincs", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("solvent_settle", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("innerloop_method_cuda", "pairlist_cuda"); // mel && axel
  ...
  fc.unlock("leus", "pairlist_cuda"); // mel && axel
  fc.unlock("leus", "cutoff_atomic");
  fc.unlock("leus", "cg_martini");
  fc.unlock("leus", "multi_grain");
  ...
  fc.unlock("xray", "pairlist_cuda"); // mel && axel
  fc.unlock("xray", "cutoff_atomic");
  fc.unlock("xray", "cg_martini");
  fc.unlock("xray", "multi_grain");
  ...
  fc.unlock("sasa", "pairlist_cuda"); // mel && axel
  fc.unlock("sasa", "cutoff_atomic");
  //fc.unlock("sasa", "coarse_grain");
  //fc.unlock("sasa", "multi_grain");
  ...
  fc.unlock("sasavol", "pairlist_cuda"); // mel && axel
  fc.unlock("sasavol", "cutoff_atomic");
  //fc.unlock("sasavol", "coarse_grain");
  //fc.unlock("sasavol", "multi_grain");
  ...
  fc.unlock("pairlist_gridcell", "ramd");
  ...
  fc.unlock("force_groups", "pairlist_cuda"); // mel && axel
