...
::Eds_Nonbonded_Set(Pairlist_Algorithm & pairlist_alg,  PairlistContainer & pairlist_container,
                    Nonbonded_Parameter & param, int rank, int num_threads)
  : Nonbonded_Set(pairlist_alg, pairlist_container, param, rank, num_threads),
    m_eds_outerloop(param),
    m_perturbed_pairlist(pairlist_container.dim_i, pairlist_container.dim_j) //changed
{
       ...
       bool quiet)
{
  ...
  //changed removed: perturbed_pairlist().resize(topo.num_atoms());
