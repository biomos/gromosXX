...
::Perturbed_Nonbonded_Set(Pairlist_Algorithm & pairlist_alg,  PairlistContainer & pairlist_container,
  ...
  : Nonbonded_Set(pairlist_alg, pairlist_container, param, rank, num_threads),
    ...
    m_perturbed_pairlist(pairlist_container.dim_i, pairlist_container.dim_j)
{ //changed
}
