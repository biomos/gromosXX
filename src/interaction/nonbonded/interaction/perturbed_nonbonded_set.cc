			 ...
			 simulation::Simulation & sim)
{
  ...
  if (sim.param().perturbation.pert2d){
    for(unsigned int i = 0; i < lj_e_size; ++i){
      m_storage.perturbed_energy_derivatives.pert2d_lj[i] += 
        m_longrange_storage.perturbed_energy_derivatives.pert2d_lj[i];
      m_storage.perturbed_energy_derivatives.pert2d_ljs[i] += 
        m_longrange_storage.perturbed_energy_derivatives.pert2d_ljs[i];
      m_storage.perturbed_energy_derivatives.pert2d_crf[i] += 
        m_longrange_storage.perturbed_energy_derivatives.pert2d_crf[i];
      m_storage.perturbed_energy_derivatives.pert2d_crfs[i] += 
        m_longrange_storage.perturbed_energy_derivatives.pert2d_crfs[i];
    }
  }
