 ...
 * Constructor.
 */
interaction::OMP_Nonbonded_Interaction::OMP_Nonbonded_Interaction(Pairlist_Algorithm *pa, PairlistContainer *pc)
...
#pragma omp parallel
    {
      ...
      if (tid >= number_of_cpus) {
        ...
        CUDA_Nonbonded_Set * cuda_nbs = new CUDA_Nonbonded_Set(*m_pairlist_algorithm, *m_pairlist_container, m_parameter, 0, 1, gpu_tid);
