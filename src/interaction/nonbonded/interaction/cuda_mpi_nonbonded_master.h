/**
 * @file cuda_mpi_nonbonded_master.h
...
#ifndef INCLUDED_CUDA_MPI_NONBONDED_MASTER_H
#define INCLUDED_CUDA_MPI_NONBONDED_MASTER_H
...
namespace interaction
{
   ...
   */
  class CUDA_MPI_Nonbonded_Master :
  ...
  public:    
     ...
     * Constructor.
     */
    CUDA_MPI_Nonbonded_Master(Pairlist_Algorithm *pa, PairlistContainer *pc); //changed
    /**
     * Destructor.
     */
    virtual ~CUDA_MPI_Nonbonded_Master();
    /**
