...
(
  ...
  if(t_nonbonded_spec::interaction_func == simulation::lj_crf_2d_func){
    DEBUG(11, "\tfound lj_crf_2d_func");
	  }
  if(t_nonbonded_spec::interaction_func == simulation::lj_crf_pert_eds_func){
    DEBUG(11, "\tfound lj_crf_pert_eds_func");
	  }
