...
namespace interaction
{
  ...
  public:
    ...
    /**
     * calculate the force, energy and dh/dl of an atom pair, for 2D perturbations.
     */
    void lj_crf_soft_2d_interaction(math::Vec const &r,
                                    ...
                                    double &pert2d_lamJ_crf, double &pert2d_lamJ_crfs, unsigned int eps = 0);
    /**
     * calculate the force, energy and dh/dl of an atom pair, for 2D perturbations
     * for atoms not involved in the 2d pert.
     */
    void lj_crf_soft_2d_other_interaction(math::Vec const &r,
                                    double const A_c6, double const A_c12,
                                    double const B_c6, double const B_c12,
                                    double const A_q, double const B_q,
                                    double const alpha_lj, double const alpha_crf,
                                    ...
                                    double &e_lj, double &e_crf,
                                    double &de_lj, double & de_crf, 
                                    double &pert2d_lj, double &pert2d_ljs, 
                                    double &pert2d_crf, double &pert2d_crfs,unsigned int eps = 0);
    /**
    ...
    /**
     * calculate the reaction field force and energy
     * of a perturbed atom pair (for extendedTI)
     */
    ...
    /**
     * calculate the reaction field force and energy
     * of a perturbed atom pair, for 2d perturbation
     */
    void rf_soft_2d_interaction(math::Vec const &r, double const A_q, double const B_q,
        double const alpha_crf, math::Vec & force, double &e_rf, double & de_rf,
        double &pert2d_crf, double &pert2d_crfs,
        bool selfterm_correction = false, unsigned int eps = 0);
     ...
     * set the lambdas
     */
    void set_lambda_2d(double const lamI_lj, double const lamJ_lj,
    ...
    /**
     * 2D Perturbation, not n1-n2:
     * set the lambdas
     */
    void set_lambda_2d_other(double const lj_lambda, double const ljs_lambda,
                    double const crf_lambda, double const crfs_lambda,
                    double const lj_lambda_derivative, double const ljs_lambda_derivative,
                    double const crf_lambda_derivative, double const crfs_lambda_derivative,
                    int const n);
  protected:
   ...
   /**
     ...
     * 2D perturbation
     */
    double lamA_lj, lamAB_lj, lamBA_lj, lamB_lj;
    double lamA_ljs,lamAB_ljs,lamBA_ljs,lamB_ljs;
    double lamA_lj_deriv, lamAB_lj_deriv, lamBA_lj_deriv, lamB_lj_deriv;
    double lamA_ljs_deriv,lamAB_ljs_deriv,lamBA_ljs_deriv,lamB_ljs_deriv;
    double lamA_crf, lamAB_crf, lamBA_crf, lamB_crf;
    double lamA_crfs,lamAB_crfs,lamBA_crfs,lamB_crfs;
    double lamA_crf_deriv, lamAB_crf_deriv, lamBA_crf_deriv, lamB_crf_deriv;
    double lamA_crfs_deriv,lamAB_crfs_deriv,lamBA_crfs_deriv,lamB_crfs_deriv;

    double lj_lambda, ljs_lambda, crf_lambda, crfs_lambda;
    double lamI_lj, lamJ_lj;
    double lamI_lj_deriv, lamI_ljs_deriv, lamJ_lj_deriv, lamJ_ljs_deriv;
    double dfA_dlamI_ljs, dfAB_dlamI_ljs, dfBA_dlamI_ljs, dfB_dlamI_ljs;
    double dfA_dlamJ_ljs, dfAB_dlamJ_ljs, dfBA_dlamJ_ljs, dfB_dlamJ_ljs;
    double lamI_crf, lamJ_crf;
    double lamI_crf_deriv, lamI_crfs_deriv, lamJ_crf_deriv, lamJ_crfs_deriv;
    double dfA_dlamI_crfs, dfAB_dlamI_crfs, dfBA_dlamI_crfs, dfB_dlamI_crfs;
    double dfA_dlamJ_crfs, dfAB_dlamJ_crfs, dfBA_dlamJ_crfs, dfB_dlamJ_crfs;
