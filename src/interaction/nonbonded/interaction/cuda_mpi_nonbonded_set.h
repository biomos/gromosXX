...
{
  /**
   * @class CUDA_MPI_Nonbonded_Set
   * calculates the nonbonded interactions.
   */
  class CUDA_MPI_Nonbonded_Set : public Nonbonded_Set_Interface
  {
  public:    
    /**
     * Constructor.
    ...
    CUDA_MPI_Nonbonded_Set(Pairlist_Algorithm & pairlist_alg, PairlistContainer & pairlist_container,
                  Nonbonded_Parameter & param, int rank, int num_threads);   //changed
    
    /**
     * Destructor
     */
    virtual ~CUDA_MPI_Nonbonded_Set() {}
