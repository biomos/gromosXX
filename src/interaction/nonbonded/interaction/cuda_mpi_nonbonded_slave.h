/**
 * @file cuda_mpi_nonbonded_slave.h
...
#ifndef INCLUDED_CUDA_MPI_NONBONDED_SLAVE_H
#define INCLUDED_CUDA_MPI_NONBONDED_SLAVE_H
...
namespace interaction
{
   ...
   */
  class CUDA_MPI_Nonbonded_Slave :
  ...
  public:    
     ...
     * Constructor.
     */
    CUDA_MPI_Nonbonded_Slave(Pairlist_Algorithm *pa, PairlistContainer *pc); //changed
    /**
     * Destructor.
     */
    virtual ~CUDA_MPI_Nonbonded_Slave();
    /**
