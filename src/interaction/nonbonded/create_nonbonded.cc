 ...
 )
{
  ...
  if (sim.param().force.interaction_function ==
      ...
      simulation::lj_crf_2d_func ||
      sim.param().force.interaction_function ==
      simulation::lj_crf_pert_eds_func ||
      sim.param().force.interaction_function ==
  ...
  if (!quiet){
    ...
    if (sim.param().force.interaction_function == simulation::lj_crf_func ||
        sim.param().force.interaction_function == simulation::lj_crf_2d_func ||
        sim.param().force.interaction_function == simulation::lj_crf_pert_eds_func ||
