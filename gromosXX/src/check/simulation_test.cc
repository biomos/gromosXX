...
void Simulation_Test::check_simulation_results_forces() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // "current" forces
...
void Simulation_Test::check_simulation_results_velocities() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // "current" velocities
...
void Simulation_Test::check_simulation_results_positions() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
...
void Simulation_Test::check_simulation_results_temperature_baths() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // "current" energies
...
void Simulation_Test::check_simulation_results_bonded_terms() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // "current" energies
...
void Simulation_Test::check_simulation_results_nonbonded_terms() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // "current" energies
...
void Simulation_Test::check_simulation_results_special_terms() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
...
void Simulation_Test::check_simulation_results_mass() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // current
...
void Simulation_Test::check_simulation_results_temperature() {
...
void Simulation_Test::check_simulation_results_volume() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // current
...
void Simulation_Test::check_simulation_results_pressure() {
  std::unordered_map<Key::keys, double>& doubles_res = results_.doubles_;
  // current
