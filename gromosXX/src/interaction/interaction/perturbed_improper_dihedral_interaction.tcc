...
inline interaction::Perturbed_Improper_Dihedral_Interaction<t_simulation, t_interaction_spec>
::Perturbed_Improper_Dihedral_Interaction(
  ...
  : Interaction<t_simulation, t_interaction_spec>("Perturbed Improper Dihedral"),
 ...
 */
template<typename t_simulation, typename t_interaction_spec>
inline void interaction::Perturbed_Improper_Dihedral_Interaction<t_simulation, t_interaction_spec>
