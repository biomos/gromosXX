...
//SWAPPING Functions
void util::replica_exchange_base_eds::determine_switch_probabilities(){
...
void util::replica_exchange_base_eds::swap_replicas_1D(const unsigned int partnerReplicaID) {
