...
_repo_test_dir='extTI_test'
_config_file='extTI_param.yaml'
######## specific code for the test ########
...
class Test_extTI_MD(Base_MD_Test):
    test_conf = _test_conf

# test ene
from ..helper_fnc._tre_tests import extTI_Tests_tre
class Test_extTI_tre(extTI_Tests_tre):
    test_conf = _test_conf

# test free ene
from ..helper_fnc._trg_tests import extTI_Tests_trg
class Test_extTI_trg(extTI_Tests_trg):
    test_conf = _test_conf
######## specific code for the test ########
