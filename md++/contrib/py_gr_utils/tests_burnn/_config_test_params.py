...
class ConfigTest():
    ...
    def get_run_string(self):
        ...
        self.qmmm = os.path.join(self.input_dir, self.config['input']['QMMM'])
        self.run_str += _md_header.format(TOPO=self.topo, IUNIT=self.iunit, INPUTCRD=self.icrd, QMMM=self.qmmm)
