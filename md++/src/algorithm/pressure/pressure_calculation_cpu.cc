...
/**
 * @file pressure_calculation_cpu.cc
 * calculates the pressure -- CPU backend.
 */
...
template<>
int algorithm::Pressure_Calculation<util::cpuBackend>
...
template class algorithm::Pressure_Calculation<util::cpuBackend>;
