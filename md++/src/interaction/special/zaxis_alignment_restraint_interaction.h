/**
 * @file zaxis_alignment_restraint_interaction.h
...
namespace interaction
{
   ...
   */
  class Zaxis_Alignment_Restraint_Interaction : public Interaction
  {
  public:
    /**
     * Constructor.
     */
    Zaxis_Alignment_Restraint_Interaction() : Interaction("ZalignRestraint"),
        exponential_term(0.0) {}

    /**
     * Destructor.
     */
    virtual ~Zaxis_Alignment_Restraint_Interaction() {}
