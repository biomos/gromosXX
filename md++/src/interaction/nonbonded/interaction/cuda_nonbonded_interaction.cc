...
interaction::CUDA_Nonbonded_Interaction::~CUDA_Nonbonded_Interaction() {
  DEBUG(7, "CUDA_Nonbonded_Interaction::destructor");
 ...
 */
int interaction::CUDA_Nonbonded_Interaction::calculate_interaction
(
 ...
 */
int interaction::CUDA_Nonbonded_Interaction::calculate_hessian
(
        topology::Topology & topo,
        configuration::Configuration & conf,
        simulation::Simulation & sim,
...
int interaction::CUDA_Nonbonded_Interaction::init(topology::Topology & topo,
  ...
  topology::Topology * p_topo = &topo;
  if (sim.param().multicell.multicell) {
    io::messages.add("Not implemented", "multicell", io::message::critical);
    return 1;
    ...
    //           "boundary conditions (LSEPS=0.0)", "multicell", io::message::error);
    //   return 1;
    // }
...
int interaction::CUDA_Nonbonded_Interaction::check_special_loop
(
 ...
 */
void interaction::CUDA_Nonbonded_Interaction::store_set_data
(
        topology::Topology const & topo,
        configuration::Configuration & conf,
...
void interaction::CUDA_Nonbonded_Interaction::init_expand_configuration
(
        topology::Topology const & topo,
        configuration::Configuration & conf,
        simulation::Simulation & sim,
...
void interaction::CUDA_Nonbonded_Interaction::expand_configuration
(
        topology::Topology const & topo,
        configuration::Configuration & conf,
        simulation::Simulation & sim,
...
void interaction::CUDA_Nonbonded_Interaction::_expand_configuration
(
        topology::Topology const & topo,
        configuration::Configuration & conf,
        simulation::Simulation & sim,
 ...
 * simulations
 */
void interaction::CUDA_Nonbonded_Interaction::reduce_configuration
(
        topology::Topology const & topo,
        configuration::Configuration & conf,
        simulation::Simulation & sim,
 ...
 * print the pairlist
 */
int interaction::CUDA_Nonbonded_Interaction::print_pairlist
(
        topology::Topology & topo,
        configuration::Configuration & conf,
        simulation::Simulation & sim,
  ...
  DEBUG(4, "CUDA_Nonbonded_Interaction::print_pairlist");
